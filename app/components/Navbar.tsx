  ...
  return (
    <>
      ...
      <div
        ...
        className={`relative z-[998] transition-colors duration-200 ${hoveredDropdown ? 'bg-primary-900' : 'bg-white shadow-lg'}`}
      >
        ...
        <div className="overflow-hidden transition-all duration-300 ease-in-out">
          {navLinks.map(({ name, megaMenu }) => (
            hoveredDropdown === name && megaMenu && (
              <div key={name} className="animate-fadeInDown w-full text-gray-900 z-[997] relative shadow-md">
